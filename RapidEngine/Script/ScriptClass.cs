...
namespace JScript.Script
{
    ...
    public class ScriptClass
    {
            ...
            else
            {
                ...
                else
                {
                    throw new ScriptException(
                     String.Format("'{0}' requires a data type of {1}",
                            name,
                            value.Type), new Token()
        ...
        {
            ScriptTypes[] args = { };
            var tr = typeof(TResult).GetScriptTypes();
        ...
        {
            var t1 = typeof(T1).GetScriptTypes();
            var tr = typeof(TResult).GetScriptTypes();
            ScriptTypes[] args = { t1 };
            Methods.Add(new ScriptFunction(name, function, args, tr));
        }
        ...
        {
            var t1 = typeof(T1).GetScriptTypes();
            var t2 = typeof(T2).GetScriptTypes();
            var tr = typeof(TResult).GetScriptTypes();
        ...
        public void AddAction<T1, T2, T3>(string name, Action<T1, T2, T3> action)
        {
            var t1 = typeof(T1).GetScriptTypes();
            var t2 = typeof(T2).GetScriptTypes();
            var t3 = typeof(T3).GetScriptTypes();
